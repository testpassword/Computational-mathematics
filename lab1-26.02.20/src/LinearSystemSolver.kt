...
/**
 * Функция-расширения, возвращающая, диагональные элементы любой матрицы.
 * @return массив, состоящий из диагональных элементов матрицы.
 */
fun Array<DoubleArray>.getDiagonalElements() = mapIndexed { i, el -> el[i] }

/**
 * Класс, содержащий результат решения СЛАУ, согласно шаблону Data Model Object.
 * @property xVector вектор неизвестных.
